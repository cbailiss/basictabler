...
A basic example of quickly printing a pivot table to the console using the `qtbl()` function: 
...
The `qtbl()` function is nothing more than a concise version of a more verbose syntax, i.e.
